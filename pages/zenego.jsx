    ...
    <div className="w-full">
      <div className="w-screen h-[30vh] lg:h-[40vh] relative">
        ...
        <Image
          ...
          objectFit="cover"
          src={zenegoImg}
          alt="screen of the Zenego app"
        />
        <div className="absolute top-[70%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] z-10 p-2">
          <h2 className="py-2">Next sophrology app</h2>
          <h3>Next</h3>
        </div>
      </div>
      ...
      <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8">
        <div className="col-span-4">
          ...
          <p>This is my last project at school</p>
          <a href="" target="_blank" rel="noreferrer">
            <button disabled className="px-8 py-2 mt-4 mr-8 opacity-[0.2]">
              Demo
            </button>
          </a>
          <a
            href="https://github.com/NycoChavanoud/atempo"
            target="_blank"
            rel="noreferrer"
          >
